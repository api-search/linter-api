"use strict";
var _Rule_instances, _a, _Rule_severity, _Rule_enabled, _Rule_then, _Rule_given, _Rule_resolveAlias, _Rule_resolveAliasForFormats;
...
class Rule {
    ...
    set given(given) {
        ...
        (0, tslib_1.__classPrivateFieldSet)(this, _Rule_given, this.owner.hasComplexAliases
            ? actualGiven
            : actualGiven.flatMap(expr => (0, tslib_1.__classPrivateFieldGet)(this, _Rule_instances, "m", _Rule_resolveAlias).call(this, expr, null)).filter(lodash_1.isString), "f");
    }
    getGivenForFormats(formats) {
        return this.owner.hasComplexAliases ? (0, tslib_1.__classPrivateFieldGet)(this, _Rule_given, "f").flatMap(expr => (0, tslib_1.__classPrivateFieldGet)(this, _Rule_instances, "m", _Rule_resolveAlias).call(this, expr, formats)) : (0, tslib_1.__classPrivateFieldGet)(this, _Rule_given, "f");
    }
...
exports.Rule = Rule;
_a = Rule, _Rule_severity = new WeakMap(), _Rule_enabled = new WeakMap(), _Rule_then = new WeakMap(), _Rule_given = new WeakMap(), _Rule_instances = new WeakSet(), _Rule_resolveAlias = function _Rule_resolveAlias(expr, formats) {
    var _b;
    ...
    resolve: for (const expression of expressions) {
        ...
        while (resolvedExpr.startsWith('#')) {
            const alias = (_b = ALIAS.exec(resolvedExpr)) === null || _b === void 0 ? void 0 : _b[1];
